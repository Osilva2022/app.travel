        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-5 justify-content-center g-4 align-items-center">
                    ...
                    <ul class="nav pb-2 mb-2 justify-content-center">
                        <li class="">
                            <a class="text-muted" href="{{ config('constants.FACEBOOK_URL') }}" target="_blank">
                                <img src="https://s3.us-west-2.amazonaws.com/app.tribunetravel/2022/08/face-white-ico.svg" alt="Tribune Travel facebook-icon" width="24" height="24">
                            </a>
                        </li>
                        <li class="ms-3">
                            <a class="text-muted" href="{{ config('constants.PINTEREST_URL') }}" target="_blank">
                                <img src="https://s3.us-west-2.amazonaws.com/app.tribunetravel/2022/08/pint-white-ico.svg" alt="Tribune Travel pint-icon" width="24" height="24">
                            </a>
                        </li>
                        <li class="ms-3">
                            <a class="text-muted" href="{{ config('constants.INSTAGRAM_URL') }}" target="_blank">
                                <img src="https://s3.us-west-2.amazonaws.com/app.tribunetravel/2022/08/inst-white-ico.svg" alt="Tribune Travel insta-icon" width="24" height="24">
                            </a>
                        </li>
                        <li class="ms-3">
                            <a class="text-muted" href="{{ url('rss') }}" target="_blank" aria-label="rss">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-rss" viewBox="0 0 16 16">
                ...
                <div class="col text-center text-white">
                    ...
                    <ul class="nav pb-2 mb-2 justify-content-center">
                        <li class="">
                            <a class="text-muted" aria-label="Subscribe" href="{{route('subscription')}}" target="_blank">
        ...
        <div class="row row-cols-4 g-2 g-lg-3 justify-content-center mb-4">
            <div class="col-12 col-footer text-center">
                <a href="https://cps.media/" target="_blank">
                    <img src="https://s3.us-west-2.amazonaws.com/app.tribunetravel/2022/08/cps-media-white.svg" class="img-footer" alt="CPS Logo" loading="lazy" decoding="defer" style="width: 25%;">
                </a>
            </div>
            <div class="col col-footer text-center">
                <a href="https://tribunadelabahia.com.mx/" target="_blank">
                    <img src="https://s3.us-west-2.amazonaws.com/app.tribunetravel/2022/08/tribuna-white.svg" class="img-footer" alt="Tribuna Logo" loading="lazy" decoding="defer">
                </a>
            </div>
            <div class="col col-footer text-center">
                <a href="https://radiante.fm/" target="_blank">
                    <img src="https://s3.us-west-2.amazonaws.com/app.tribunetravel/2022/08/radiante-white-horizontal.svg" class="img-footer" alt="Radiante Logo" loading="lazy" decoding="defer">
                </a>
            </div>
            <div class="col col-footer text-center">
        ...
        <div class="row justify-content-center">
            <div class="col-12 mb-4">
                <div class="row  g-1 justify-content-center text-center">
                    ...
                    <div class="col-md-3 px-4">
                        <a class="text-white" href="https://cps.media/declaracion-de-accesibilidad" style="text-decoration: none;" target="_blank">
                ...
                <div class="modal-body">
                    <form class="form-floating" method="GET" action="{{ route('search') }}">
                        <div class="input-group">
                            <input type="search" name="search" class="form-control" placeholder="Search this site..." aria-label="Search" aria-describedby="button-addon2" autofocus autocomplete="off">
        ...
        <div class="row">
            <div class="col d-flex flex-column flex-md-row justify-content-around align-items-center">
                <p class="text-center" style="font-size: 12px; margin: 0;">
                    ...
                    to accept the <a href="{{ route('cookies') }}">Cookies policy</a> & <a href="{{ route('privacy') }}">Privacy policy</a>.
                </p>
