                ...
                <div class="container">
                    <div class="row g-2">
                        ...
                        <div class="btn-group col text-white text-center d-lg-none d-block">
                            <a class="text-white" data-bs-toggle="dropdown" style="background-color: #243A85;" href="#" title="Base: MXN">
                        ...
                        <div class="btn-group col text-white d-flex justify-content-center">
                            <a title="{!! $weather['Vallarta']['text'] !!}" class="text-white" data-bs-toggle="dropdown" style="background-color: #243A85;" href="#">
            ...
            <div class="col-12">
                    ...
                    <div class="col-sm-12 mb-2">
                        <div class="owl-carousel owl-theme ttd-carousel" id="">
                            ...
                            <div class="ttd-slider-item">
                                <a href="{{ route('guide_category', ["$ttd->destination_slug", "$ttd->category_slug"]) }}?p={!! $ttd->ID !!}">
                ...
                <div class="row">
                    <div class="col-12 mt-4 d-flex justify-content-center">
                        <a href="{{ url('guide') }}?destination=puerto-vallarta" class="btn-view-more" type="button">Show More</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card card-secundario">
                            <div class="row h-100">
                                ...
                                <div class="col-6 card-body-secundario">
                                    <a href="{{ route('destinations', ["$data->destination_slug"]) }}">
                                        <span class="etiqueta-post" style="background:{{ $data->destination_color }};">
                                            {!! $data->destination !!}
                                        </span>
                                    </a>
                                    <a href="{{ url("$data->url") }}">
                    ...
                    <div class="col d-flex flex-column align-items-center">
                        ...
                        <div class="">
                            ...
                            <a class="text-muted" href="{{ config('constants.FACEBOOK_URL') }}">
                                <img src="{{ asset('img/svg/face-ico.svg') }}" loading="lazy" decoding="defer" alt="Tribune Travel facebook-icon" width="24" height="24">
                            </a>
                            <a class="text-muted" href="{{ config('constants.PINTEREST_URL') }}">
                                <img src="{{ asset('img/svg/pint-ico.svg') }}" loading="lazy" decoding="defer" alt="Tribune Travel pint-icon" width="24" height="24">
                            </a>
                            <a class="text-muted" href="{{ config('constants.INSTAGRAM_URL') }}">
                                <img src="{{ asset('img/svg/inst-ico.svg') }}" loading="lazy" decoding="defer" alt="Tribune Travel insta-icon" width="24" height="24">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="card card-secundario h-100">
                            <div class="row h-100">
                                ...
                                <div class="col-6 card-body-secundario">
                                    <a href="{{ route('destinations', ["$data->destination_slug"]) }}">
                                        <span class="etiqueta-post mb-2" style="background:{{ $data->destination_color }};">
                                            {!! $data->destination !!}
                                        </span>
                                    </a>
                                    <a href="{{ url("$data->url") }}">
