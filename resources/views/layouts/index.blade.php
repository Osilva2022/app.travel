                ...
                <div class="col-lg-6">
                    <div class="card mb-3 border-0">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                <a href="{{ url("$destination/$category/post/$review->slug") }}"
                                    title="{{ $review->title }}" class="text-decoration-none text-muted test-error">
                            ...
                            <div class="tab-pane fade  {{ $active }}" id="tag-{{ $data->term_id }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <a href="{{ route('things',"puerto-vallarta") }}" class="btn btn-primary form-control rounded-pill" type="button">More
                                            things to do</a>
                                    </div>
                                </div>
                            </div>
