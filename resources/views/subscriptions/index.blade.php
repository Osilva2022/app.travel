          ...
          <div>
            <div class="card-body p-5">
              ...
              @if (session()->has('success'))
                ...
                @endif
              <form method="POST" action="{{ route('save_subscription') }}" autocomplete="off" name="form1">
                @csrf
                <div class="mb-3">
                ...
                <div id="accordion">
                    <div >
                        <p class="accordion-header" id="headingOne" style="font-size: 20px; color:#243A85;">
                                Categories: 
                        </p>
                        <p style="font-size: 16px; color:#243A85; font-weight:600;">Choose those topics you love:</p>
                        <div  aria-labelledby="headingOne"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <input type="checkbox" name="group4" style="font-size: 20px;" value="1" class="form-check-input tag-check" id="select_all">
                                <label class="form-check-label" >
                                    Selected all
                                </label>
                                @foreach ($categories_data as $category)
                                <div class="form-check" style="font-size: 14px;">
                                    <input class="form-check-input tag-check" type="checkbox" name="category[]"
                                        value="{!! $category->term_id !!}" id="tag-{!! $category->term_id !!}">
                                    <label class="form-check-label" for="tag-{!! $category->term_id !!}">
                                        {!! $category->name !!}
                                    </label>
                                </div>
                                @endforeach
